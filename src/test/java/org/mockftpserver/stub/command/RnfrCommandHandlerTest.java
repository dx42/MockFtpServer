 ...
 * @author Chris Mair
 */
class RnfrCommandHandlerTest extends AbstractCommandHandlerTestCase {
    ...
    void testHandleCommand() throws Exception {
        ...
        verify(session, times(2)).sendReply(ReplyCodes.RNFR_OK, replyTextFor(ReplyCodes.RNFR_OK));
