 ...
 * @author Chris Mair
 */
class RntoCommandHandlerTest extends AbstractCommandHandlerTestCase {
    ...
    void testHandleCommand() throws Exception {
        ...
        verify(session, times(2)).sendReply(ReplyCodes.RNTO_OK, replyTextFor(ReplyCodes.RNTO_OK));
