 ...
 * @author Chris Mair
 */
class ReinCommandHandlerTest extends AbstractCommandHandlerTestCase {
    ...
    void testHandleCommand() throws Exception {
        ...
        verify(session, times(2)).sendReply(ReplyCodes.REIN_OK, replyTextFor(ReplyCodes.REIN_OK));
