 ...
 * @author Chris Mair
 */
class AcctCommandHandlerTest extends AbstractCommandHandlerTestCase {
    ...
    void testHandleCommand() throws Exception {
        ...
        verify(session, times(2)).sendReply(ReplyCodes.ACCT_OK, replyTextFor(ReplyCodes.ACCT_OK));
